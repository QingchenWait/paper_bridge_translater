...
foreach ($name in @('strikethrough','shapes','rectangle-horizontal','circle','gallery-vertical-end','bookmark','folder-plus','folder-input','layout-grid','list','arrow-up','arrow-down','folder-tree','eye-off','move','rotate-ccw','a-arrow-up','a-arrow-down')) {
